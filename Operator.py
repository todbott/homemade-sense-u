...
class SensorController:
    ...
    def __init__(self, monitoring_type, minutes, first_warning, second_warning) -> None:
    ...
    def main(self):
        ...
        if self.monitoring_type == "in_room":
            self.__monitor_in_room()
        else:
    ...
    def __monitor_in_room(self):
        ...
        while True:
            ...
            self.__checkForMovementAndMakeSounds(movement_this_time)
